...
public class WeatherService extends IntentService {
    ...
    private static final String BASE_URL = "https://api.darksky.net/forecast/9927ca20d9cc673bc823a4c903801670/";
    public static final String BROADCAST_WEATHER = "webservice.action.BROADCAST";
    ...
    private void fetchWeatherData(String key, String lat, String lon, String time) {
        try {
            ...
            if (response == HttpURLConnection.HTTP_OK) {
                ...
                Log.d(TAG, "fetchWeatherDataL " + condition + " " + time);
